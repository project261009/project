const CONFIG = {
    ...
    confirmTitle: "YEAAAY! gabisa kann🎂",
    confirmText: "Mulai sekarang kamu udaa 16 tahunnn",
    badgeText: "pi besday cayang",
    nextButton: "Lanjut 🎁",
    repeatButton: "Ulangi pertanyaan",
    flowerTitle: "Ini kado ulang tahun buat kamu 🎂",
    takeBouquetButton: "Terima hadiahnya 🎁",
    bouquetMessage: "Bercandaa bee nanti yang asli nyusul yaaa 💕",
    nextFlowerButton: "Next 🎉",
    collageTitle: "My Special You",
    collageSubtitle: "Sejak kamu hadir, ulang tahun jadi lebih istimewa. Happy Birthday, my favorite person 🎂💕",
    nextCollageButton: "Satu halaman lagi… 🎁",
    finalTitle: "Happy Birthday, My Love 🎂💞",
    finalMessage: `Makasih ya sudah hadir dan bikin hariku selalu bahagia. Kamu adalah alasan kenapa senyum itu mudah muncul. Semoga ulang tahunmu penuh kehangatan dan kebahagiaan. Aku selalu ada untukmu. Happy Birthday Sayanggg 💕`,
